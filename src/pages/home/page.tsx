...
import BottomNav from "../../components/BottomNav"; // 경로는 src 구조에 맞게 조정
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <button className="w-8 h-8 flex items-center justify-center">
                      <i className="ri-heart-line text-gray-400 text-lg hover:text-red-500 transition-colors"></i>
                    </button>
                  </div>
